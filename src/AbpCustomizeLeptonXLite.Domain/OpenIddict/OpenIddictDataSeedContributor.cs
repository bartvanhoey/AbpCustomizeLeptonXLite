...
namespace AbpCustomizeLeptonXLite.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("AbpCustomizeLeptonXLite") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "AbpCustomizeLeptonXLite", DisplayName = "AbpCustomizeLeptonXLite API", Resources = { "AbpCustomizeLeptonXLite" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["AbpCustomizeLeptonXLite_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["AbpCustomizeLeptonXLite_App:RootUrl"]?.TrimEnd('/');
        ...
        // Blazor Client
        var blazorClientId = configurationSection["AbpCustomizeLeptonXLite_Blazor:ClientId"];
        if (!blazorClientId.IsNullOrWhiteSpace())
        {
            var blazorRootUrl = configurationSection["AbpCustomizeLeptonXLite_Blazor:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["AbpCustomizeLeptonXLite_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["AbpCustomizeLeptonXLite_Swagger:RootUrl"]?.TrimEnd('/');
