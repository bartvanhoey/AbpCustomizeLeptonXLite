...
public static class AbpCustomizeLeptonXLiteEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE AbpCustomizeLeptonXLiteModuleExtensionConfigurator CLASS (in the Domain.Shared project)
