...
public class AbpCustomizeLeptonXLiteDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public AbpCustomizeLeptonXLiteDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
